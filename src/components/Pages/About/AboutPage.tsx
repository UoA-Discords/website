    ...
    return (
        <Container maxWidth="xl" id="app" sx={{ mt: 2 }}>
            ...
            <Paper sx={{ m: 1, p: 2 }} elevation={12}>
                ...
                <Link href="https://discord.com/guidelines" target="_blank" rel="noreferrer noopener">
            ...
            <Paper sx={{ m: 1, p: 2 }} elevation={12}>
                ...
                <Link href="https://discord.gg/XmdRWSCy2U" target="_blank" rel="noreferrer noopener">
                    Discord server
                </Link>
